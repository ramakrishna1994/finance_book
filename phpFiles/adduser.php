...
$insertQuery = "insert into users(name,days,fine_days,address,princ_amount,daily,interest,fine,phone,aadhar,extras) values('".$name."',".$days.",".$fine_days.",'".$address."',".$princ_amount.",".$daily.",".$interest.",".$fine.",'".$phone."','".$aadhar."','".$extras."');";
